...
public class AudioStorage {
    ...
    AudioStorage() {
        audioList.add(new Audio("audioFiles\\ix27ve-seen-scary-things-151751.wav", 0));
        ...
        audioList.add(new Audio("audioFiles\\pojar-odinochnyii-korotkii-shumnyii-udar.wav", 0.3, 1400));
