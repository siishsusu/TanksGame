...
public class AudioStorage {
    ...
    AudioStorage() {
        ...
        audioList.add(new Audio("audioFiles\\knopka-komnatnogo-pereklyuchatelya1.wav", 1));
        ...
        audioList.add(new Audio("audioFiles\\pojar-odinochnyii-korotkii-shumnyii-udar.wav", 1, 1600));
        ...
        audioList.add(new Audio("audioFiles\\zvuk-tsikla-shuma-proizvodimogo-dizelnyim-dvigatelem-40552_wNUUejwY.wav", 0.6, 470));
    }
