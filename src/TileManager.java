...
public class TileManager {
    ...
    public void getTileImage() {
        ...
        tile[0].brake = true;
        tile[1] = new Tile();
        tile[1].image = new ImageIcon("imgs/brickwall-5.png").getImage();
        tile[1].collide = true;
        tile[2] = new Tile();
        ...
        tile[7].collide = true;
        tile[8] = new Tile();
        tile[8].image = new ImageIcon("imgs/tree-sand.png").getImage();
        tile[8].collide = true;
        tile[9] = new Tile();
        tile[9].image = new ImageIcon("imgs/brickWall.jpg").getImage();
        tile[9].collide = true;
